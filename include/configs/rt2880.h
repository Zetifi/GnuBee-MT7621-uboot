...
#define CFG_FLASH_OFFSET_IMG_A   (CFG_BOOTLOADER_SIZE + CFG_CONFIG_SIZE + CFG_FACTORY_SIZE)
#define CFG_FLASH_OFFSET_IMG_B   0xFE0000
#define CFG_KERN_ADDR            (CFG_FLASH_BASE + CFG_FLASH_OFFSET_IMG_A)
#define CFG_KERN_ADDR_IMG_A      CFG_KERN_ADDR
#define CFG_KERN_ADDR_IMG_B      (CFG_FLASH_BASE + CFG_FLASH_OFFSET_IMG_B)
